        ...
        for i in range(0,int(count, 16)):
            ...
            for i in range(1,value+1):
                ...
                if value1 in paramdict:
                    print( " the {} id is {}/{} with value {}".format(i,value1,paramdict.get(value1),value))
                else:
            ...
            for i in range(1,value+1):
                ...
                if value1 in paramdict:
                    if value1==78:
                        ...
                        print( " the {} id is {}/{} with value {}".format(i,value1,paramdict.get(value1),driverid))
                    else:
                        print( " the {} id is {}/{} with value {}".format(i,value1,paramdict.get(value1),value))
                else:
                     print( " the {} id is {} with value {}".format(i,value1,value))
...
process_data("")
