...
def process_data(data):
    ...
    if (len(data)>34):
        ...
        print("AVL data coun is {}".format(int(count, 16)))
        data = data[2:]
        ...
        print( "The event id {} was generated by {}".format((int(value, 16)),paramdict.get(int(value, 16))))


        data,value=parse_string(data,2,"Element Count")
        print("Element Count is {}".format(int(value, 16)))
